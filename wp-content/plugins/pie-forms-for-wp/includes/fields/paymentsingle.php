...
class PFORM_Fields_PaymentSingle extends PFORM_Abstracts_Fields{
	...
	*/
	...
	public function field_preview( $field , $form_data) {
		...
		do_action('pie_forms_payment_single_field_builder_insider' , $field, $form_data, $this);
	}
	...
	public function field_display( $field, $field_atts, $form_data ) {
		...
		do_action('pie_forms_payment_single_field_frontend' , $field, $field_atts, $form_data);
	}
